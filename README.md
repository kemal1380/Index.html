...
<body>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='ã‹¡'>
       <p id="kalimat">Saya Ada Sesuatu Nih ðŸ¤£â¤ï¸</p>

       <p id="pesan1">Klik 4 LOVE di Bawah! ðŸ˜†â¤ï¸</p>
       <div id="kolombaru">
         <li id="lv1">ðŸ¤</li>
         <li id="lv2">ðŸ¤</li>
         <li id="lv3">ðŸ¤</li>
       ...
       <!-- Pesan -->
       <p id="pesan3" class = "gaya2">maaf ya nindi kalau saya sedikit cuek ðŸ¤£â¤ï¸</p>
       <p id="pesan4" >Happy Birthday yaaaa, </p>
       <p id="pesan5" class="gaya2">nambah tua aja ya, hehe</p>
       <p id="pesan6" class="gaya2">semoga panjang umur sampai 100 tahun ya nindi ðŸ˜†â¤ï¸</p>
       <p id="pesan7" class="gaya2">sehat dan berkah selalu yaa nindi!</p>

       <p id="pesan8" class="gaya2">bercanda yaa nindi wkwwk :v</p>
       <p id="pesan9" class="gaya2">Oh iya, semoga di hari spesialmu ini kamu dapat menjadi pribadi yang lebih baik yaa.. ðŸ¥³â¤ï¸</p>
       <p id="pesan10" class="gaya2">Happy Level Up Day!! ðŸ¥³</p>
     ...
     <!-- Pesan Tambahan -->
     <p id="katatambahan" class="sembunyi">Gajadi deh soalnya nindi bau dan belum mandi hahahahaha ðŸ˜œ</p>
     
     <!-- Pesan Ditolak -->
     <div id="pesanditolak">
       <img id="stikerditolak" src="https://feeldreams.github.io/weee.gif"/>
       <p id="kataditolak">Hmmmm yaudah kalo nindi gamau mah ðŸ˜œ</p>
     </div>
